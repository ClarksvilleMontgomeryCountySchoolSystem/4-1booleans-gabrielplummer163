...
'''The variable names that were easiest to work with were the names 
that did not have the word 'Not' in it. This is because the questions were 
straightforward and had nothing else to them.'''
# Which were most confusing? Why?
'''The variable names that were most confusing are the names with
the word 'Not in it. This is because the word not
 switches the correct answer to the opposite.'''
